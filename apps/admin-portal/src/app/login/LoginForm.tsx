  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="hidden lg:flex flex-col justify-center items-center px-16 
                      bg-gradient-to-br from-[#193cb8] via-[#1632a0] to-[#101f6f]
                      text-white relative overflow-hidden">
        {/* Background decoration */}
        <div className="absolute inset-0 opacity-15">
          <div className="absolute top-20 left-16 w-64 h-64 bg-white/25 rounded-full blur-3xl" />
          <div className="absolute bottom-16 right-12 w-80 h-80 bg-[#3b57d4] rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative z-10 max-w-md">
          ...
          <div className="mt-12 space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-blue-50">Secure & reliable platform</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="shrink-0 w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-blue-50">Lightning-fast operations</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center py-12 px-6 lg:px-16">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-8 text-center">
            <div className="text-2xl font-bold text-blue-600 mb-4">Admin Dashboard</div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition duration-200 bg-white"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition duration-200 bg-white"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#193cb8] to-[#132a86] hover:from-[#132a86] hover:to-[#101f6f] 
                         text-white font-semibold py-3 rounded-lg shadow-lg hover:shadow-xl 
